...
class AgentDependencies:
    ...
    async def initialize(self) -> None:
        ...
        if not self.settings:
            ...
            logger.info(f"Settings loaded: database={self.settings.mongodb_database}")
        ...
        if not self.mongo_client:
            try:
                ...
                logger.info(
                    f"MongoDB connected: database={self.settings.mongodb_database}, "
        ...
        if not self.openai_client:
            ...
            logger.info(
                f"OpenAI client initialized: model={self.settings.embedding_model}, "
